...
const registerSchema = z.object({
  ...
  hospitalName: z.string().min(1, "Hospital name is required").min(3, "Hospital name must be at least 3 characters"),
  role: z.enum(["admin", "physician", "nurse", "technician", "billing", "auditor"], {
...
const roles = [
  ...
  { value: "physician", label: "Physician", description: "Access to patient records, prescriptions, and clinical notes" },
  { value: "nurse", label: "Nurse", description: "Access to patient records, vitals, and care plans" },
  { value: "technician", label: "Technician", description: "Access to lab results, imaging, and procedures" },
  { value: "billing", label: "Billing Staff", description: "Access to insurance, billing, and coding" },
  { value: "auditor", label: "Auditor", description: "Read-only access for compliance reviews" },
]
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
          ...
          <div>
            ...
            {errors.role && (
              <p className="mt-1.5 text-sm text-danger" role="alert">{errors.role.message}</p>
            )}
          </div>
          ...
          {errors.terms && (
            <p className="text-sm text-danger" role="alert">{errors.terms.message}</p>
          )}
